...
class SceneObject {
    ...
    public:
        ...
        void setup() const;
        void render(unsigned char render_mode = 0, bool left_eye = false) const;
        void renderFur(unsigned int instance_countunsigned, unsigned char render_mode = 0, bool left_eye = false) const;
